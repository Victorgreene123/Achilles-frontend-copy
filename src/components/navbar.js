...
<<<<<<< HEAD
    console.log("closed");
=======
>>>>>>> 572a1ef81b1796d7ea2d8b595943b43885066612
  };
  ...
  return (
    <>
      <nav className='bg-white sticky top-0 w-full p-2.5 flex items-center shadow z-10'>
        <Link to='/'>
          <img src='/images/achelis.png' alt='Achilles drill logo' className='h-11 ml-2 w-20' />
        </Link>
<<<<<<< HEAD
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div className='flex justify-end p-4'>
            <button onClick={closeMobileMenu} className='text-blue-800 focus:outline-none'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='24'
                height='24'
          ...
          <ul className='flex flex-col gap-4 text-blue-800'>
            ...
            <li className='text-blue-800'>
              <Link to='/BlogPage' onClick={closeMobileMenu}>
                Blog
              </Link>
            </li>
            <li className='text-blue-800'>
            ...
            <li>
              <button
                class='flex items-center bg-blue-800 text-white border border-blue-800 rounded-full p-2.5 h-10 gap-1.5 w-full justify-center'
