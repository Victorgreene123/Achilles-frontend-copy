...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <div className='flex items-center justify-between w-full'>
          <div className='hidden md:flex items-center ml-5 w-full'>
            ...
            <div className='flex items-center justify-center gap-10 ml-10 w-1/3'>
              ...
              <button   onClick={openFormModal} className='flex items-center bg-blue-800  text-sm text-white border border-blue-800 rounded-full p-2.5 h-10 gap-1.5'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='24'
                  height='24'
      ...
      {isMobileMenuOpen && (
        <div  className={`md:hidden bg-white fixed top-0 left-0 w-full h-screen z-20 transform transition-transform duration-300 ease-in-out ${
          ...
          <li className={getNavLinkClass('/')}>
            ...
            <li>
              <button className='bg-[#214198] items-center mx-auto flex text-white py-2 px-5 rounded-full' onClick={() =>{
                closeMobileMenu()
                openFormModal()
