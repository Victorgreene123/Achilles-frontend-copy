...
const TrustedSchools = () => {
  return (
    <div>
      <div className="lg:flex items-center justify-evenly  space-y-5">
        <div className="text-center border-b-2 py-8">
          <p className="">Trusted by:</p>
        </div>
        <div className="place-items-center border-l-2 border-b-2 grid grid-cols-3 lg:grid-cols-9 gap-3 lg:space-x-16 py-5">
          <img src={image1} alt="" />
          <img src={image2} alt="" />
          <img src={image3} alt="" />
          <img src={image4} alt="" />
