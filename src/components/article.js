export const articles = [
  {
    ...
    fullText: `1️. The first step to simplifying any difficult topic is to break it down into smaller easy-to-digest chunks. Don’t attempt to take it from the top and expect to cover it all. Breaking the topics into smaller chunks gives room for you to set short term goals and there is a sense of achievement that comes as you cover these smaller sub topics which makes you more interested in going further. 
      2. Engage multiple senses by incorporating visual aids, diagrams, audio books and mnemonics into your study. The topic is hard enough already, so don’t try to learn it by using just one approach such as “reading textbooks” alone, You will find yourself forgetting what you’ve read no matter how many times you try. Instead, integrate multiple senses into your learning; visual, auditory, motor and you do this by using Video tutorials, Audio books, Flashcards, solving Past Questions etc. This activates multiple memory and learning centers of the brain and allows you understand the topic in multiple learning pathways. 
      3️. Utilize spaced repetition techniques. When you finish a particular topic, my brother, it’s not over yet, the next day when you’re about to move on to another subtopic, ensure you revise the areas you already covered. Repetition can be hard but it’s probably the most proven ways to consolidate memory. 
      4️. Find creative ways to apply theoretical knowledge to real-life scenarios or clinical cases. 
  ...
  },
  {
    ...
    description:
      "I once asked a student what he thinks about time management, and all he could imagine was “how to allocate time when we study”. This is the mistake many people make; thinking Time management is only applicable to us 'when we study'.",
    fullText: `These 5 TIPS will increase your productivity by 100×, do SAVE for later✅ 
    1️. Learn the art of "time blocking" where you schedule out EVERY part—and I mean every part—of your day. Allocate specific periods for study, relaxation, socializing, quality time with your babe (let's say you have one) and every other activity that place in your day. Leave none out. This gives you a psychological understanding and preparation of what should be happening at every hour of your day.
    ...
    3. Be true to yourself. Funmi, that “9 hours for reading” you wrote in your timetable won't work and we both know it. Learn to space out your study period and spice it up with breaks, exercise, games, etc.
...
`,
  },
  {
    ...
    description:
      "You've probably heard the phrase “study smarter not harder” more times that you can count but do you even know what it means?",
    fullText: `For a start, whenever we study, our sole goal is to convert the short term memory gathered to long term memories. The “Learning Cone” emphasises that after 2 weeks, we only remember 10% of what we “read”, 20% of what we “hear”, 30% of what we “see”, 50% of what we “see and hear”, 70% of what we”say” and 90% of what we “say and do”. 📌If your goal is to remember ALL you study, then your focus should be on “Seeing”, “Hearing” and “Doing” whatever read. Here are practical steps to effect this👇🏽
    1. Read a topic the same day you’re taught. Resist that urge to sleep over it. Read it that same day because the memory is still fresh and you can easily recall the events that took place during the course of the lecture.
    ...
    3. Task yourself with flashcards. This activates the kinesthetic pathway of consolidating memory. The action of flipping flashcards acts as a way of “Doing” something. Don’t forget you remember 90% of what we say and do.
